...
5. Run the workflow again with publishing enabled. It verifies the version and tag identity, reruns the complete release gate, publishes `NdsForge` and `NdsForge.Cli`, and creates the GitHub release.
