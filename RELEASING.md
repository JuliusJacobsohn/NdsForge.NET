...
5. Run the workflow again with publishing enabled. It verifies the version and tag identity, reruns the complete release gate, publishes `NdsForge`, `NdsForge.Nitro`, `NdsForge.Graphics`, `NdsForge.Audio.Wav`, and `NdsForge.Cli`, and creates the GitHub release.
